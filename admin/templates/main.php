...
<table class="form-table">
   <tbody>
      ...
      <tr>
         ...
         <td>
            <?php $call_back_page = get_home_url().'/wp-content/plugins/circleaccess-wordpress-circle-lite/callback.php'; ?>
            ...
            <input name="circleauth_callback_page" readonly type="text" id="callback_page"
               ...
               <button class="btn" style="border: none" type="button" data-toggle="tooltip" title="Copy to Clipboard!" data-clipboard-callback data-clipboard-target="#callback_page">
                 <img style="cursor:pointer;width:15px;" src="<?php echo plugin_dir_url(dirname(__FILE__)).'images/clippy.svg'; ?>" width="15" alt="Copy to clipboard">
         ...
         <td >
            ...
            <div style="display: flex;margin-top:8px">
               ...
               <div style="padding-left: 15px;">
                  <span class="circleaccess-description">
